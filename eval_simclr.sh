...
for i in "" "_1" "_2" "_3" "_4"; do
    python evaluate_domain_filtering.py --dataset "yoga$i" --training_method simclr --network simclr_resnet
done

for i in "" "_1" "_2" "_3" "_4"; do
    python evaluate_domain_filtering.py --dataset "rock$i" --training_method simclr --network simclr_resnet
done

for i in "" "_1" "_2" "_3" "_4"; do
    python evaluate_domain_filtering.py --dataset "eurosat$i" --training_method simclr --network simclr_resnet
done
